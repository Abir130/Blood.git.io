    ...
    <div class="login-dark ">
        <div class="form-section">
            <form method="post" action="<?php echo base_url()?>admin-insert">
                <h2 class="title text-center">Registration Forms</h2>
				<div class="row">
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group mb-3">
							<select name="city" id="id_parent" data-child-id='id_child' class='form-select dependent-selects__parent' required>
								...
								<!-- Dhaka -->
								<option value="Dhaka"
								data-child-options="Tangail|#Kishoreganj|#Manikganj|#Dhaka|#Gazipur|#Narsinghdi|#Narayanganj|#Munshiganj|#Faridpur|#Rajbari|#Gopalganj|#Madaripur|#Shariatpur">
								Dhaka
								</option>
								<!-- Khulna -->
								<option value="Khulna"
								data-child-options="Kushtia|#Meherpur|#Chuadanga|#Jhenaidah|#Magura|#Narail|#Jashore|#Satkhira|#Khulna|#Bagerhat">
								Khulna
								</option>
								<!-- Rangpur -->
								<option value="Rangpur"
								data-child-options="Panchagar|#Thakurgaon|#Dinajpur|#Nilphamari|#Lalmonirhat|#Rangpur|#Kurigram|#Gaibandha">
								Rangpur
								</option>

								<!-- Rajshahi -->
								<option value="Rajshahi"
								data-child-options="Joypurhat|#Bogura|#Naogaon|#Natore|#Nawabganj|#Rajshahi|#Sirajganj|#Pabna">
								Rajshahi
								</option>
								...
								data-child-options="Brahmanbaria|#Cumilla|#Chandpur|#Lakshmipur|#Noakhali|#Feni|#Chattogram|#Cox’s-Bazar|#Khagrachhari|#Rangamati|#Bandarban">
								Chattogram
								</option>
							</select>
						</div>
