				...
				<form action="<?php echo base_url() ?>update-profile" method="post">
					<div class="row">
						...
						<div class="col-sm-12 col-md-6">
							...
							<div class="form-floating mb-3">
								<select onclick="test()" name="city" id="id_parent" data-child-id='id_child' class='form-select dependent-selects__parent' required>
									...
									<!-- Khulna -->
									<option value="Khulna" data-child-options="Kushtia|#Meherpur|#Chuadanga|#Jhenaidah|#Magura|#Narail|#Jashore|#Satkhira|#Khulna|#Bagerhat">
										Khulna
									</option>
									<!-- Rangpur -->
							...
							<div class="form-floating mb-3">
								<select name="district" id="id_child" class='form-select dependent-selects__child'>
