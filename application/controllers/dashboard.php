...
class Dashboard extends CI_Controller {
	...
	{	
		...
		$this->db->from('tbl_blood');
		$this->db->where('city', 'Barisal');
		$data['blood_barisal']=$this->db->count_all_results();

		$this->db->from('tbl_blood');
		$this->db->where('city', 'Chittagong');
		$data['blood_chittagong']=$this->db->count_all_results();
	...
	public function user_list(){
		...
		$this->load->model('search_user');  
		 ...
		 $data['user_district']=$this->search_user->user_district_data('','');  
	...
	public function donor_list(){
		...
		$data['user_district']=$this->search_user->user_district_data('type','Donor');    
         //return the data in view  
         $this->load->view('table', $data);  
	}
	...
	public function volunteer_list(){
		...
		$this->load->model('search_user');  
         ...
         $data['user_data']=$this->search_user->volunteer_list_data();
		  $data['user_district']=$this->search_user->user_district_data('type','Volunteer');    
         //return the data in view  
         $this->load->view('table', $data);  
	}
